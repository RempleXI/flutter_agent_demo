...
class ApiService {
  // 发送消息到AI API
  static Future<ChatMessage?> sendMessage(String text, List<ChatMessage> history) async {
  ...
  // 发送消息到指定模型的AI API
  static Future<ChatMessage?> _sendMessageWithModel(String text, String modelName, List<ChatMessage> history) async {
    try {
      final configService = ExternalConfigService();
  ...
  // 构建消息历史
  static List<Map<String, String>> _buildMessages(List<ChatMessage> history, String currentText) {
